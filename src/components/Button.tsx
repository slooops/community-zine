...
export const inputClass =
  'w-full rounded-none border border-gray-700 bg-gray-900 text-white placeholder:text-gray-600 px-3 py-2.5 text-sm focus:outline-none focus:border-[#D94550] transition';
